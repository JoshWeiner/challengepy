...
usersHeader = {"UserID":"INTEGER PRIMARY KEY", "Username":"TEXT UNIQUE", "Password":"TEXT", "Favorites": "TEXT"}
createTable("users", usersHeader)

clubsHeader = {"ClubID":"INTEGER PRIMARY KEY", "club_name":"TEXT UNIQUE", "tags":"TEXT", "description":"TEXT", "favorites":"INTEGER",}
createTable("clubs", clubsHeader)
